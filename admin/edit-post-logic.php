...
if(isset($_POST['submit'])){
    ...
    if(!$title){
        ...
        {
            $_SESSION['edit-post']="File  should be png, jpg, gif or jpeg ";
    ...
    if(isset($_SESSION['edit-post'])){
        ...
        $thumbnail_to_insert= $thumbnail_name ?? $previous_thumbnail_name;
            ...
            $query="UPDATE posts SET title='$title', thumbnail='$thumbnail_to_insert' ,category_id='$category_id',is_featured=$is_featured WHERE id=$id LIMIT 1";
