...
<!-- end of nav -->
    ...
    <!-- shows add category was success -->
    ...
    <!-- shows if add category was not success -->
    ...
    <?php endif?>
    <!-- shows if edit category was success -->
    ...
    <!-- shows edit category was not success -->
    ...
    <!-- shows if delete category was success -->
        ...
        <div class="container dashboard_container">
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="manage-users.php"><i class="uil uil-list-ul"></i>
                        <h5>Manage User</h5></a>
                    </li>
                    ...
                    <li>
                        <a href="manage-categories.php" class="active"><i class="uil uil-pen"></i>
