...
if(isset($_POST['submit'])){
    ...
    if(!$title){
        ...
        {
            $_SESSION['add-post']="File  should be png, jpg, gif or jpeg";
    ...
    else
    {
        ...
        $query="INSERT INTO posts (title,thumbnail, category_id, author_id, is_featured) VALUES ('$title', '$thumbnail_name', $category_id , $author_id, $is_featured)";
